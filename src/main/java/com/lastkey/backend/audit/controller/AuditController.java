...
public class AuditController {
	...
	public Page<AuditLogResponse> getActorLogs(
		...
		return auditLogService.getLogsByActor(email, PageRequest.of(page, size));
	}
	...
	public Page<AuditLogResponse> getResourceLogs(
		...
		return auditLogService.getLogsByResource(resource, PageRequest.of(page, size));
	}
	...
	public Page<AuditLogResponse> getBetweenDates(
		...
		return auditLogService.getLogsBetween(start, end, PageRequest.of(page, size));
	}
}